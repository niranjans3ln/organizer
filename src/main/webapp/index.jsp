...
<head>
  ...
  <title>BS5LND Corp. (Kaya Sarathi Reddy & Family Corporation)</title>
...
<section class='container'>
          <hgroup>
            <h1>Welcome to BS5LND Corp. (Kaya Sarathi Reddy & Family Corporation)</h1>
          </hgroup>
        <div class="row">
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>My Organizer</h2>
                <p>This site is meant for accessing the mobile application "My Organizer" and all its functionalities.</p>
            </section>
          </section>
       </div>
       <div>
       	<a href="${pageContext.request.contextPath}/register.jsp"> New User? Register Here.....</a>
       </div>
        <footer>
          <div class="logo"><img alt="BS5LND Corp. (Kaya Sarathi Reddy & Family Corporation)" src="./images/logo.png"></a></div>
        </footer>
</section>
</body>
</html>
